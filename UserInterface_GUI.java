...
public class UserInterface_GUI extends JFrame implements ActionListener
{
   ...
   // private PaymentPanel        cPaymentPanel;
    ...
    public UserInterface_GUI(Controller_GUI rController)
    {
        ...
        // Set frame
        setTitle("Sistema de Administración de restaurante");
    ...
    private void createMasterPanelConpornents()
    {
        ...
        headTitle = new JLabel("Sistema de Gestión de Órdenes y Pedidos - Restaurante");
        ...
        mainBtnShowMenu = new JButton("Mostrar menu");
        ...
        mainBtnManageEmployee = new JButton("Gestionar empleados");
        mainBtnManageEmployee.addActionListener(this);
        mainBtnsPanel.add(mainBtnManageEmployee);
        
        mainBtnManageMenuItem = new JButton("Gestionar items del menú");
        mainBtnManageMenuItem.addActionListener(this);
        mainBtnsPanel.add(mainBtnManageMenuItem);
        
        mainBtnShowTotalSales = new JButton("Mostrar ventas totales");
       ...
       // mainBtnsPanel.add(mainBtnShowPayment);
        ...
        taMessage.setText("Bienvenido!!");
        taMessage.setOpaque(true);
        btnClockOut = new JButton("Cerrar");
    ...
    public void setLoginUserName(String newName)
    {
        currentUserName = newName;
         if(newName == "")
         {
             labelLoginUserName.setText("Porfavor has login primero.");
         }
         else
         {
    ...
    *****************************************************************/
    private class LoginPanel extends JPanel implements ActionListener
    {
        ...
        public LoginPanel()
        {
            ...
            lblUserID = new JLabel("ID DE Usuario:");
            ...
            chbIsManager = new JCheckBox("Login como manager");
            gbc.gridx = 0;
            gbc.gridy = 2;
            gbc.gridwidth = 2;
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnLoginOK)
            {
                ...
                {
                    displayErrorMessage("Ingrese la contraseña");
                    return;
                }
                
                if( rcController.loginCheck(Integer.parseInt(inputID), inputPassword, isManager))
                {
                    showConfirmDialog("Message", "Login exitoso!!");
    ...
    *****************************************************************/       
    private class MenuListPanel extends JPanel implements ActionListener
    {
        ...
        public MenuListPanel()
        {
           ...
           btnAll = new JButton("Todo");
           btnAll.addActionListener(this);
           btnMain = new JButton("Plato fuerte");
           btnMain.addActionListener(this);
           btnDrink = new JButton("Bebidas");
           btnDrink.addActionListener(this);
           btnAlcohol = new JButton("Alcohol");
           btnAlcohol.addActionListener(this);
           btnDessert = new JButton("Postres");
    ...
    *****************************************************************/    
    private class MenuManagementPanel extends JPanel implements ActionListener
    {
        ...
        public MenuManagementPanel()
        {
            ...
            btnAddNewMenuItem     = new JButton("Añadir nuevo item");
            ...
            btnEditMenuItem    = new JButton("Editar item del menú");
            ...
            btnDeleteMenuItem   = new JButton("Eliminar item del menú");
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            else if (ae.getSource() == btnDeleteMenuItem)
            {
                ...
                if( showYesNoDialog("", "¿Estas seguro de querer eliminar el item del menú?") == DIALOG_YES)
                {
    ...
    *****************************************************************/       
    private class EditMenuItemPanel extends JPanel implements ActionListener
    {
        ...
        public EditMenuItemPanel()
        {
            ...
            lblName = new JLabel("Menu item nombre:");
            ...
            lblPrice = new JLabel("Menu item precio:");
            ...
            lblType = new JLabel("Tipo de item de Menú:");
            ...
            String[] combodata = {"Principal", "Bebidas", "Alcohol", "Postres"};
        ...
        public void init(int menuItemID)
        {
            ...
            if( rMenuItem == null)
            {
                showErrorDialog("Error", "Obtención de menu item data fallido.");
                setItemName("");
                setPrice("");
                setType("Main");
                return;
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnOK)
            {
                ...
                {
                    displayErrorMessage("Completa todo el formulario!");
                    return;
                }
                ...
                else if( strMenuType.equals("Bebidas"))
                {
                ...
                if(isUpdate)
                {
                    ...
                    showConfirmDialog("Message", "Actualziación exitosa!!");
                }
                else
                {                   
                    ...
                    showConfirmDialog("Message", "Nuevo item de menú añadido!");
                }
                init(menuItemID);
            }
        }
    ...
    *****************************************************************/       
    private class EmployeeListPanel extends JPanel implements ActionListener
    {
        ...
        public EmployeeListPanel()
        {
            ...
            btnAddStaff     = new JButton("Añadir nuevo staff");
            ...
            btnEditStaff    = new JButton("Editar staff");
            ...
            btnDeleteStaff   = new JButton("Eliminar staff");
            ...
            btnClockOut  = new JButton("Salida");
            btnClockOut.addActionListener(this);
            gbc.gridx = 3;
            gbc.gridy = 1;
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnAddStaff)
            {
                ...
                changeMainPanel("EditarEmpleado");
            }
            ...
            else if (ae.getSource() == btnDeleteStaff)
            {
                ...
                if( showYesNoDialog("", "Estas seguro de querer eliminar el staff?") == DIALOG_YES)
                {
            ...
            else if (ae.getSource() == btnClockOut)
            {
                int staffID = getSelectedStaffID();
                if( staffID == -1)    return;
                if(showYesNoDialog("", "¿Estas seguro de cerrar  la salida del staff?") == DIALOG_NO)
                    return;
                if( rcController.clockOut(staffID) == false)
                    showErrorDialog("Error", rcController.getErrorMessage());
                else
                {
                    displayMessage("El estaff se ha cerrado.");
                    init();
                }
            }
        }
    ...
    *****************************************************************/       
    private class EditEmployeePanel extends JPanel implements ActionListener
    {
        ...
        public void init(int employeeID)
        {
            ...
            if( rStaff == null)
            {
                showErrorDialog("Error", "Obtención de los datos de staff fallido.");
                setLastName("");
                setFirstName("");
                return;
            }
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnOK)
            {
                ...
                if(isUpdate)
                {
                    ...
                    showConfirmDialog("Message", "Actualización exitosa!!");
                }
                else
                {
                    boolean isManager = false;
                    
                    if( showYesNoDialog("", "Añadir un manager?") == DIALOG_YES)
                        isManager = true;
                    ...
                    showConfirmDialog("Message", "Nuevo staff ha sido añadido!!");
    ...
    *****************************************************************/       
    private class OrderListPanel extends JPanel implements ActionListener
    {
        ...
        public OrderListPanel()
        {
            ...
            btnCloseOrder   = new JButton("Cerrar");
            ...
            btnCancelOrder  = new JButton("Cancelar");
        ...
        {
            lblTotalCount.setText("Orden de hoy: " + count);
        }
        ...
        {
            lblCancelCount.setText("Ordenes canceladas: " + count);
        }
        
        private void setCancelTotal( double sales)
        {
            lblCancelTotal.setText("total cancelado:$ " + sales);
        }
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            else if (ae.getSource() == btnCloseOrder)
            {
                ...
                if( showYesNoDialog("Close order","Quieres cerrar la orden?") == DIALOG_YES)
                {
    ...
    *****************************************************************/       
    private class OrderDetailPanel extends JPanel implements ActionListener, ListSelectionListener
    {
        ...
        public OrderDetailPanel()
        {
            ...
            btnDeleteItem   = new JButton("Eliminar");
            ...
            lblRightTitle = new JLabel("Lista de Menú");
            gbc.gridx = 0;
            gbc.gridy = 0;
            gbc.ipadx = 0;
            gbc.gridwidth = 5;
        ...
        public void init(int orderID, String staffName)
        {
            ...
            switch(currentOrderState)
            {
                case Order.ORDER_CLOSED:
                    setOrderState("Cerrada");
                break;
                case Order.ORDER_CANCELED:
                    setOrderState("Cancelada");
                break;
                default:
                break;
            }
        ...
        {
            lblTotalSales.setText("Cargo total: $" + total);
        }
        
        private void setOrderState(String state)
        {
            lblOrderState.setText("Estado de Orden: " + state);
        }
        
        private void setStaffName(String name)
        {
            lblStaffName.setText("Nombre del staff: " + name);
        }
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnAddItem)
            {
                ...
                {
                    showErrorDialog("Error", "Ingresar cantidad!!");
                    return;
                }
                ...
                displayMessage("Menu ID = "+ id + " Cantidad = " + quantity);
