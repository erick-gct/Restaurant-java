...
public class Controller_GUI
{
    ...
    public boolean loginCheck( int inputID, String inputPassword, boolean isManager)
    {
        ...
        if( rStaff != null)//User data is found
        {
            ...
            {
                setErrorMessage("No encontrado usuario.");
    ...
    public boolean deleteMenuItem(int id)
    {
        ...
        if(rMenuItem == null)
        {
            setErrorMessage("Menu item ID:" + id + " no es encontrado.");
            return false;
        }
    ...
    public boolean closeOrder(int closeOrderID)
    {
        ...
        if( currentUserID != rOrder.getStaffID())
        {
            setErrorMessage("No puedes cancelar la orden.\n(La orden pertence a  " + rOrder.getStaffName() + ")");
            return false;    
        }
        
        if(rOrder.getState() != 0)
        {
            setErrorMessage("La orden ya esta cerrada o cancelada.");
            return false;
        }
    ...
    public boolean cancelOrder(int cancelOrderID)
    {
        ...
        if( currentUserID != rOrder.getStaffID())
        {
            setErrorMessage("No puedes eliminar la orden.\n(La orden pertenece a  " + rOrder.getStaffName() + ")");
            return false;    
        }
        
        if( rOrder.getState() != 0)
        {
            setErrorMessage("La orden ya está cerrada o cancelada.");
            return false;
        }
     ...
     **********************************************************/
     public String generateSalesReport()
     {
        ...
        {
             setErrorMessage("Todas las ordenes deben estar generadas o cancelada antes de generar el reporte.");
             return null;
        }
    ...
    public String generatePaymentReport()
    {
        ...
        {
            setErrorMessage("Todo el staff debe estar revisado antes de generar el reporte de pagos.");
            return null;
        }
